...
const GhostCorePanel: React.FC<GhostCorePanelProps> = ({ 
  ...
  return (
    <Panel title="snufulufugus core" subtitle="core systems">
      <div className="grid grid-cols-1 gap-6">
        ...
        <PanelSection title="snufulufugus vpn">
            <p className={`text-sm mb-4 ${isTorModeActive ? 'text-gray-600' : 'text-gray-400'}`}>Routes traffic through the snufulufugus network. Disabled when Tor Mode is active.</p>
